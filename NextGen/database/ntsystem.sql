...
--
-- Host: localhost
-- Generation Time: Feb 24, 2021 at 06:28 PM
...
(45, '210224-2253', '2021-02-01', '2021-02-28', 1, '2021-02-24 22:54:53');
...
(344, '210224-2253', 2, 6, 14, 27.47, 15000.00, 12000.00, '[{\"amount\":\"6000.00\",\"aname\":\"House Rent\"},{\"amount\":\"2500.00\",\"aname\":\"Phone Allowance\"},{\"amount\":\"3500.00\",\"aname\":\"Dearness Allowance\"}]', 5000.00, '[{\"amount\":\"5000.00\",\"dname\":\"Provident Fund\"}]', 22000.00, 100.00, '2021-02-24 22:54:55'),
(345, '210224-2253', 3, 6, 14, 34.86, 15300.00, 2550.00, '[{\"amount\":\"2550.00\",\"aname\":\"Phone Allowance\"}]', 5100.00, '[{\"amount\":\"5100.00\",\"dname\":\"Provident Fund\"}]', 12750.00, 0.00, '2021-02-24 22:54:55'),
(346, '210224-2253', 4, 3, 17, 16.58, 7800.00, 1040.00, '[{\"amount\":\"1040.00\",\"aname\":\"Dearness Allowance\"}]', 0.00, '[]', 8840.00, 0.00, '2021-02-24 22:54:55'),
(347, '210224-2253', 8, 4, 16, 27.63, 11491.20, 3000.00, '[{\"amount\":\"3000.00\",\"aname\":\"Phone Allowance\"}]', 0.00, '[]', 14491.20, 0.00, '2021-02-24 22:54:55');
...
--
ALTER TABLE `leaves`
  MODIFY `sno` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `payroll`
--
ALTER TABLE `payroll`
  MODIFY `sno` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;

--
-- AUTO_INCREMENT for table `payroll_items`
--
ALTER TABLE `payroll_items`
  MODIFY `sno` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=348;

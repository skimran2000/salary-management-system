...
<body>
	...
	<div class='container-fluid'>
				...
				<div class='content-bodyes'>
					...
					<div class='contriner-fluid' id='p'>
						...
						<div class='col-md-6'>
							...
							<h5><b>Basic Salary &emsp;&emsp;&emsp;&emsp;&ensp;&nbsp;: &emsp;&emsp;<small style="font-size:17px"><?php echo "₹ ".$bsal ?></small></b></h5>
							<hr class="divider" style="border-color:black">
		...
		while($data = Db::assoc($query)):  ?>
									...
									<h5><b><?php echo "Total Amount : &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&ensp;&nbsp;₹ ".$totalw ?></b></h5>
							</div>
						</div>
		...
		while($data = Db::assoc($query)):  ?>
									...
									<h5><b><?php echo "Total Amount : &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&ensp;&nbsp;₹ ".$totded ?></b></h5>
									<!--echo str_repeat("&nbsp;", 60); -->
							</div>
						</div>
					</div>
					...
					<h5><b>Income Tax &emsp;&emsp;&emsp;&emsp;&emsp;: &emsp;&emsp;<small style="font-size:17px"><?php echo "₹ ".$it ?></small></b></h5>

					<h5><b>Net Salary &emsp;&emsp;&emsp;&emsp;&emsp;&ensp;&nbsp;: &emsp;&emsp;<small style="font-size:17px"><?php echo "₹ ".$totsal ?></small></b></h5>

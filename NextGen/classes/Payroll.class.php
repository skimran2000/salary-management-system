...
class Payroll{
	...
	public static function load(){ // displays monthly payrolls calculated
	...
	public static function loadlist($ref){ // displays the list of employees payroll
	...
	public static function delete($ref){ // deletes the payroll
		Db::delete("payroll", "ref_no = ? ", $ref);
	}

	public static function deletelist($ref){ // if we delete a payroll of month then the payslips generated will also get deleted
		Db::delete("payroll_items", "ref_no = ? ", $ref);
	}

	public static function load_es(){ // displays list of payslips to particular employee
		$query = Db::fetch("payroll", "", "", "", "sno", "", "");
		if(Db::count($query)){
			echo"<div class='form-holder'>
					<table class='table table-bordered table-stripped'> 

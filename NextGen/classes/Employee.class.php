...
class Employee{
	public static function add($token, $firstName, $secondName, $dob, $email, $phone, $img, $gender, $role, $doj, $sal, $accno){ // adding employees in database
		if($token == ""){
			...
			Db::insert(
				...
				array($firstName, $secondName, $dob, $email, $password, $token, 2, $phone, $img, $gender, $role, $doj, $sal, $accno)
			);
